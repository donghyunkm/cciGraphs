...
def save_application_experiment(fname, epoch, z, df, graph_hparams, n2v_params=None, leiden_partitions=None, z_tsne=None):
    ...
    savedict = {"z": z, "df": df, 
                ...
                "leiden_partitions": leiden_partitions, "z_tsne": z_tsne}
