...
A 0.5 mm x 0.5 mm slice of the VISp region. The different colors assigned to cells correspond to different subclasses.
:::

We note that the subclass distribution of cells in the dataset is skewed to a select few. This makes subclass classification tasks inherently more difficult. 
...
5 neuropeptide precursor and GPCR pairs were experimentally measured in the MERFISH dataset. The 5 pairs each make up a layer in the multilayer graph.
